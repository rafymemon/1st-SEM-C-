...
// called circarea() that finds the area of a circle in a similar way. It should take an argument 
// of type float and return an argument of the same type. Write a main() function 
